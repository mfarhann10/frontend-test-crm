      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 justify-between">
        ...
        <div className="space-y-6">
          <p className="font-poppins font-normal text-lg leading-relaxed text-[#0A0A0A]">
            Villa Amandha consist of two luxury villas and one
            traditional Javanese house surrounded by a 
            tranquil rain forest setting, traditional Indonesian 
            ...
            <div className="flex flex-col">
                <p className="font-poppins font-medium text-2xl">
                +2 <span className="text-[#106A64] font-semibold">/ Facilities</span>
                </p>
